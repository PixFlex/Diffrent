...
window.puzzClick = function(index) {
    ...
    // Mark as found
    c1.src = 'https://www.flashi.me/img/diff/makerD/found_green.png';
    c1.style.opacity = '1';
    const c2 = document.getElementById(`diff_${index}_2`);
    c2.src = 'https://www.flashi.me/img/diff/makerD/found_green.png';
    c2.style.opacity = '1';
...
function solve() {
    ...
    for (let i = 0; i < diffs.length; i++) {
        ...
        if (c1 && c1.style.opacity !== '1') { // If not found by player
            c1.src = 'https://www.flashi.me/img/diff/makerD/found_red.png';
            c1.style.opacity = '1';
            const c2 = document.getElementById(`diff_${i}_2`);
            c2.src = 'https://www.flashi.me/img/diff/makerD/found_red.png';
            c2.style.opacity = '1';
        }
    }
}
